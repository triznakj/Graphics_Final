...
public:
	WorldState()
	{
		...
		cameraPos = center + glm::vec3(0,0,camDistance*0.4);
		cameraLook = center;
	...
	{
		GLfloat zOffset = cameraPos[2];
		this->cameraPos = this->cameraPos + glm::vec3(motionVector, 0);
		this->cameraPos = glm::clamp(this->cameraPos, model.getMinBound(), model.getMaxBound());
		this->cameraPos.z = zOffset;
	}
};
